...
namespace Wintegra.Data.Db2Client
{
	public sealed class Db2ConnectionStringBuilder : DbConnectionStringBuilder, IDictionary<string, object>
	{
		...
		[Description("The CommandTimeout attribute specifies the amount of time, in seconds, before the request to connect to the data source is presumed to have failed. For DB2, the default is 30 seconds.")]
		[DisplayName("OdbcCommandTimeout")]
		[DefaultValue(30)]
